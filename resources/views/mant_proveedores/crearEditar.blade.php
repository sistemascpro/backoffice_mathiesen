            ...
            <div class="page-wrapper">
                <div class="page-content">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <form class="row g-3" method="post" id="Proveedores_FormGuardar" enctype="multipart/form-data">@csrf
                        ...
                        <div class="card-body">
                            ...
                            <span  class="row">
                                <div class="col-sm-4 text-secondary align-middle">
                                    <input type="button" class="btn btn-primary px-4" value="GUARDAR CAMBIOS" onclick="Proveedores_GuardarCambios();" />
                                </div>
                            </span>
                        </div>
                        </form>
