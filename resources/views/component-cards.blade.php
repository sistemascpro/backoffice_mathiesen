                    ...
                    <div class="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-xl-3">
                        <div class="col d-flex">
                            <div class="card bg-danger w-100">
                                <img src="{{ asset('assets/images/gallery/35.png') }}" class="card-img-top" alt="...">
                        ...
                        <div class="col d-flex">
                            <div class="card bg-success w-100">
                                <img src="{{ asset('assets/images/gallery/36.png') }}" class="card-img-top" alt="...">
                                <div class="card-body text-white">
                                    <h5 class="card-title text-white">Card Sample Title</h5>
                        ...
                        <div class="col d-flex">
                            <div class="card bg-warning w-100">
                                <img src="{{ asset('assets/images/gallery/37.png') }}" class="card-img-top" alt="...">
                                <div class="card-body text-white">
                                    <h5 class="card-title text-white">Card Sample Title</h5>
