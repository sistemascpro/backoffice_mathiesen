...
<html lang="en">
    ...
    <!--end wrapper-->
    <!-- Bootstrap JS -->
    <img src="{{ asset('assets/js/bootstrap.bundle.min.js') }}"></script>
    <!--plugins-->
    <img src="{{ asset('assets/js/jquery.min.js') }}"></script>
    <img src="{{ asset('assets/plugins/simplebar/js/simplebar.min.js') }}"></script>
    <img src="{{ asset('assets/plugins/metismenu/js/metisMenu.min.js') }}"></script>
    <img src="{{ asset('assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js') }}"></script>
    ...
    <!--app JS-->
    <img src="{{ asset('assets/js/app.js') }}"></script>
    </body>
