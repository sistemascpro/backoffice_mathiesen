                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item pe-3"><a href="mant_productosbloqueados">MANTENEDOR DE PRODUCTOS BLOQUEADOS</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 text-secondary">
                                    <input
                                    type="text"
                                    class="ProdBlloqueadosRequired form-control"
                                    maxlength="250"
                                    id="CodProd"
                                    name="CodProd"
                                    value=""
